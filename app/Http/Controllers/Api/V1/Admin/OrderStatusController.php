...
class OrderStatusController extends BaseController
{
     ...
     *         name="limit",
     *         in="query",
     *         description="The number of order status per page. Default is 10.",
     *         required=false,
     *         @OA\Schema(type="integer")
     *     ),
     *     @OA\Parameter(
     *         name="sortBy",
     *         in="query",
     *         description="The field to sort the order status by (id, title, slug). Default is id.",
     *         required=false,
